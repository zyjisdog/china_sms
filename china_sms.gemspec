...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore".freeze, ".travis.yml".freeze, "Gemfile".freeze, "LICENSE.txt".freeze, "README.md".freeze, "Rakefile".freeze, "china_sms.gemspec".freeze, "lib/china_sms.rb".freeze, "lib/china_sms/service/chanyoo.rb".freeze, "lib/china_sms/service/emay.rb".freeze, "lib/china_sms/service/luosimao.rb".freeze, "lib/china_sms/service/smsbao.rb".freeze, "lib/china_sms/service/tui3.rb".freeze, "lib/china_sms/service/wanxiang.rb".freeze, "lib/china_sms/service/yunpian.rb".freeze, "lib/china_sms/version.rb".freeze, "spec/china_sms_spec.rb".freeze, "spec/service/chanyoo_spec.rb".freeze, "spec/service/emay_spec.rb".freeze, "spec/service/luosimao_spec.rb".freeze, "spec/service/smsbao_spec.rb".freeze, "spec/service/tui3_spec.rb".freeze, "spec/service/yunpian_spec.rb".freeze, "spec/spec_helper.rb".freeze]
